...
class Square extends ParentShapes {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://w3.org/2000/svg"><rect x="50" y="20" width="100" height="100" fill=${this.fillColor}><text x="150" y="120" text-anchor="middle" fill=${this.textcolor}">${this.text}</text></svg>`;
    }
}
