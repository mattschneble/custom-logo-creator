...
class Triangle extends ParentShapes {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://w3.org/2000/svg"><polygon points="150, 18 244, 182 56, 182" fill="${this.fillColor}"/><text x="150" y="120" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`
    }
}
...
class Circle extends ParentShapes {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="${this.fillColor}"/><text x="150" y="120" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`;
    }
}
...
class Square extends ParentShapes {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://w3.org/2000/svg"><rect x="100" y="70" width="100" height="100" fill="${this.fillColor}"/><text x="150" y="120" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`;
    }
}
