...
describe('Square', () => {
    it("upon successful completion, a green square will be the rendered image", () => {
        ...
        expect(shape.render()).toEqual(
            '<svg version=\"1.1\" width=\"300\" height=\"200\" xmlns=\"http://w3.org/2000/svg\"><rect x="100" y="70" width="100" height="100" fill=\"green\"/><text x=\"150\" y=\"120\" text-anchor=\"middle\" fill=\"undefined\">undefined</text></svg>'
        )
    })
})